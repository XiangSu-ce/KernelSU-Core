...
import dawang.KernelSU.Core.ui.component.AppIconImage
import dawang.KernelSU.Core.ui.component.DropdownItem
import dawang.KernelSU.Core.ui.component.profile.AppProfileConfig
import dawang.KernelSU.Core.ui.component.profile.RootProfileConfig
import dawang.KernelSU.Core.ui.component.profile.TemplateConfig
import dawang.KernelSU.Core.ui.navigation3.LocalNavigator
import dawang.KernelSU.Core.ui.navigation3.Route
import dawang.KernelSU.Core.ui.util.forceStopApp
import dawang.KernelSU.Core.ui.util.getSepolicy
import dawang.KernelSU.Core.ui.util.launchApp
import dawang.KernelSU.Core.ui.util.listAppProfileTemplates
import dawang.KernelSU.Core.ui.util.ownerNameForUid
import dawang.KernelSU.Core.ui.util.pickPrimary
import dawang.KernelSU.Core.ui.util.restartApp
import dawang.KernelSU.Core.ui.util.setSepolicy
import dawang.KernelSU.Core.ui.viewmodel.SuperUserViewModel
import dawang.KernelSU.Core.ui.viewmodel.getTemplateInfoById
                ...
                when (mode) {
                    ...
                    Mode.Template -> {
                        ...
                        if (templates.isNotEmpty()) {
                            val selected = profile.rootTemplate?.takeIf { it in templates } ?: templates[0]
