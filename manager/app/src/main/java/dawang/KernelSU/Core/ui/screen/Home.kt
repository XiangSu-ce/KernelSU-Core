    ...
    Card(
        ...
        BasicComponent(
            ...
            onClick = {
                ...
                clipboard.setPrimaryClip(android.content.ClipData.newPlainText("QQ群号", "325900535"))
                android.widget.Toast.makeText(context, "QQ群号已复制: 325900535", android.widget.Toast.LENGTH_SHORT).show()
            },
