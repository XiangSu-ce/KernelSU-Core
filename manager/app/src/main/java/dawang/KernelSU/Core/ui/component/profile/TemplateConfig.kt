package dawang.KernelSU.Core.ui.component.profile
...
fun TemplateConfig(
    ...
    val profileTemplates = remember(profile.rootTemplate) { listAppProfileTemplates() }
    ...
    if (noTemplates) {
        ...
        val defaultTemplate = profile.rootTemplate?.takeIf { it in profileTemplates } ?: profileTemplates[0]
        var template by rememberSaveable { mutableStateOf(defaultTemplate) }
