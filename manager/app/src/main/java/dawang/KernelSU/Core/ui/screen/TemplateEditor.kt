...
import dawang.KernelSU.Core.ui.component.EditText
...
import dawang.KernelSU.Core.ui.util.deleteAppProfileTemplate
import dawang.KernelSU.Core.ui.util.getAppProfileTemplate
import dawang.KernelSU.Core.ui.util.setAppProfileTemplate
import dawang.KernelSU.Core.ui.viewmodel.TemplateViewModel
import dawang.KernelSU.Core.ui.viewmodel.toJSON
...
private fun TextEdit(
    ...
    EditText(
        title = label.uppercase(Locale.ROOT),
        textValue = editText,
