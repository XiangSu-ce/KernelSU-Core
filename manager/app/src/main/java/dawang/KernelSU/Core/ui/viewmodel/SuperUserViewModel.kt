package dawang.KernelSU.Core.ui.viewmodel
...
import dawang.KernelSU.Core.IKsuInterface
import dawang.KernelSU.Core.Natives
import dawang.KernelSU.Core.ksuApp
import dawang.KernelSU.Core.ui.KsuService
import dawang.KernelSU.Core.ui.component.SearchStatus
import dawang.KernelSU.Core.ui.util.HanziToPinyin
import dawang.KernelSU.Core.ui.util.KsuCli
        ...
        listLoadMutex.withLock {
            ...
            try {
                ...
                val allPackagesSlice = withContext(Dispatchers.IO) {
                    ...
                    val newApps = packages.mapNotNull {
                        val appInfo = it.applicationInfo ?: run {
                            Log.w(TAG, "Skip package without applicationInfo: ${it.packageName}")
                        ...
                        if (Build.VERSION.SDK_INT >= 29) ai?.isResourceOverlay != true else true
                    }
