...
import dawang.KernelSU.Core.ui.util.getBugreportFile
        ...
        content = {
            ...
            SuperArrow(
                ...
                onClick = {
                    scope.launch {
                        showDialog.value = false
                        val bugreportResult = loadingDialog.withLoading {
                            withContext(Dispatchers.IO) {
                                runCatching { getBugreportFile(context) }
                            }
                        }
                        val bugreport = bugreportResult.getOrNull()
                        if (bugreport == null || !bugreport.exists()) {
                            Toast.makeText(
                                context,
